...
import Almacen.appRopa;
import static Almacen.appRopa.inventarioDeRopa;
import Almacen.frmConsultar;
import Menu.frmMenu;
...
public class frmVentas extends javax.swing.JFrame {
    ...
    public frmVentas() {
        ...
        SpinnerNumberModel spinnerModel = new SpinnerNumberModel(1, 1, Integer.MAX_VALUE, 1); // Empieza en 1 y permite valores hasta el máximo entero posible
        spCantidad.setModel(spinnerModel);
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("PUNTO DE VENTA \"ZAFIRO\"");

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/papeleria (1).png"))); // NOI18N

        jLabel3.setText("Venta productos Papeleria");

        jLabel4.setText("Tel: 316-713-9163");
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(txtNroSerie, javax.swing.GroupLayout.PREFERRED_SIZE, 99, javax.swing.GroupLayout.PREFERRED_SIZE)
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addComponent(txtReferencia, javax.swing.GroupLayout.PREFERRED_SIZE, 139, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                                .addComponent(spCantidad, javax.swing.GroupLayout.PREFERRED_SIZE, 58, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    if (txtReferencia.getText().isEmpty()) {
        ...
        for (int i = 0; i < inventarioDeRopa.size(); i++) {
            if (inventarioDeRopa.get(i).getReferencia().equalsIgnoreCase(referencia)) {
                appRopa.indiceAConsultar = i;
        ...
        if (!encontrado) {
            referencia = null;
            JOptionPane.showMessageDialog(null, "La referencia " + referencia + " no se encuentra en la lista.");
            txtReferencia.requestFocus();
        } else {
            String nombre = inventarioDeRopa.get(appRopa.indiceAConsultar).getReferencia();
            double precio = inventarioDeRopa.get(appRopa.indiceAConsultar).getValorVenta();
            txtArticulo.setText(inventarioDeRopa.get(appRopa.indiceAConsultar).getArticulo());
            
            int cantidad = (int) spCantidad.getValue(); // Obtener la cantidad del JSpinner

             double total = precio * cantidad; // Calcular el total multiplicando el precio por la cantidad

             // Mostrar el total en el campo de texto txtPrecio
